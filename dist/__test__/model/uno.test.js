...
describe("Game set up", () => {
    const game = createGame({ players: ['a', 'b', 'c', 'd'], targetScore: 500 });
    ...
    it("has 'A' and 'B' as the default players", () => {
        const game = createGame({ targetScore: 500 });
    ...
    it("has 500 as the default target score", () => {
        const game = createGame({ players: ['a', 'b', 'c', 'd'] });
        expect(game.targetScore).toBe(500);
    });
    ...
    it("selects a random player as dealer", () => {
        const game = createGame({ players: ['a', 'b', 'c', 'd'], targetScore: 500, randomizer: () => 1 });
...
//# sourceMappingURL=uno.test.js.map